...
TURNS: list[dict] = [
    ...
    _spec("e2e", "你记错了，机器人翅膀是蓝色的不是红色的", 13580, [
        ("痛快认", anyof("你说得对", "对哦", "记岔", "记错了", "想岔")),
        ("不辩解", bans("我没有", "明明", "我记得是")),
    ]),
    _spec("e2e", "要是我有一只真的霸王龙就好了", 13582, [
        ("用想象给足", anyof("要是", "想象", "骑", "带它", "霸王龙")),
