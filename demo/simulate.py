...
XIAOYU_SCRIPT: list[tuple[int, list]] = [
    ...
    (2, ["今天踢球进了两个球", "我当前锋，王浩当守门员", "我们队赢啦", "拜拜"]),
    (4, ["我想当足球运动员", "每天都在练颠球", "今天颠了一百个", "嗯"]),
